...
$renovation = [
	'field' => 'renovation',
	'label' => 'Rénovation',
	'rules' => ['trim','required','max_length[5]', 'regex_match[/^[0-1]{1}$/]']
];
$id_estate_types = [
	'field' => 'id_estate_types',
	'label' => 'Type de bien',
	'rules' => ['trim','required','max_length[1]','regex_match[/^[0-9]{1}$/]']
];
$floor = [
	'field' => 'floor',
	'label' => 'Etage',
...
$condominium = [
	'field' => 'condominium',
	'label' => 'Mitoyenneté',
	'rules' => ['trim','required','max_length[1]', 'regex_match[/^[0-1]{1}$/]']
];
$joint_ownership = [
