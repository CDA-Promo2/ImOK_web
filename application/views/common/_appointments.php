    ...
    $('#calendar').fullCalendar({
      ...
      eventClick: function(e) {
        ...
        $('#show_event .modal-footer').html(
          ...
          <a href="imok_web/current/appointment/edit/${e.id_customers}/${e.id_employees}/${start_date[0]}:${start_date[1]}" class="btn btn-secondary"><i class="fas fa-pen"></i> Modifier le rendez-vous</a>
