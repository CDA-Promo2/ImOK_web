				...
				<div class="row">
						...
						<div class="form-group required">
							...
							<select type="text" name="id_customers" id="id_customers" class="form-control">
								...
								<?php foreach ($customerList as $customer): ?>
									<option value="<?= $customer->id ?>" <?= isset($estate->id_customers) && $estate->id_customers == $customer->id ? 'selected' : '' ?> ><?= $customer->lastname ?> <?= $customer->firstname ?></option>
								<?php endforeach; ?>
							</select>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="form-group required">
									...
									<input type="text" name="street" id="street" class="form-control" value="<?= $estate->street ?? '' ?>">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
									<label for="complement">Complément d'addresse</label><?= form_error('complement') ?>
									<input type="text" name="complement" id="complement" class="form-control" value="<?= $estate->complement ?? '' ?>">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group required">
					...
					<div class="col-md-6 mt-3">
						<div class="form-group">
							...
							<textarea name="description" id="description" class="form-control trumbowyg"><?= $estate->description ?? '' ?></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<input type="hidden" name="room_string" id="room_string" value="<?= $estate->rooms ? htmlentities($estate->rooms) : '' ?>">
						...
						<div class="row">
							<div class="col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="property_tax" id="property_tax" value="<?= $estate->property_tax ?? ''?>">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
									<label for="housing_tax">Taxe d'habitation</label> <?= form_error('housing_tax') ?>
									<input type="text" class="form-control" name="housing_tax" id="housing_tax" value="<?= $estate->housing_tax ?? ''?>">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
									<label for="condominium_fees">Charges de copropriétés</label> <?= form_error('condominium_fees') ?>
									<input type="text" class="form-control" name="condominium_fees" id="condominium_fees" value="<?= $estate->condominium_fees ?? ''?>">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
									<label for="annual_fees">Charges annuelles</label> <?= form_error('annual_fees') ?>
									<input type="text" class="form-control" name="annual_fees" id="annual_fees" value="<?= $estate->annual_fees ?? ''?>">
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select type="text" class="form-control" name="id_heating_types" id="id_heating_types">
									...
									<?php foreach ($heatingTypesList as $heatingTypes): ?>
										<option value="<?= $heatingTypes->id ?>" <?= isset($estate->id_heating_types) && $estate->id_heating_types == $heatingTypes->id ? 'selected' : '' ?>><?= $heatingTypes->name ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						<div class="col-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="energy_consumption" id="energy_consumption" placeholder="en kWhEP / m&sup2; /an" value="<?= $estate->energy_consumption ?? ''?>">
							</div>
						</div>
						<div class="col-12">
						...
						<div class="col-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="gas_emission" name="gas_emission" placeholder="en kg CO2 / m&sup2; /an" value="<?= $estate->gas_emission ?? ''?>">
							</div>
						</div>
						<div class="col-12">
							<ul class="gasScale">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="row">
							...
							<div class="col-12 p-4">
								<input type="hidden" name="facilities_array" id="facilities_array" value="<?= $estate->facilities ?>">
